...
+------------------------------------+------------------------------------------+-----------------------------------+
| QMC and Importance sampling        | [slide IS](slides/slide3.pdf)            | [code IS](code/code3.R)           |
+------------------------------------+------------------------------------------+-----------------------------------+
| Approximate inference              | [slide approximate](slides/slide4.pdf)   | [code approximate](code/code4.R)  |
+------------------------------------+------------------------------------------+-----------------------------------+
